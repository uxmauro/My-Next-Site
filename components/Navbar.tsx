...
<div className='hidden xl:block w-1/5 '></div>
  ...
  <Link href={'/'} className="uppercase relative group active:text-gray-950" >
    ...
    <Link href={'https://uxmauro.github.io'} target='_blank' className="uppercase relative group active:text-gray-950" ><div className='flex gap-2'> Side Projects <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
